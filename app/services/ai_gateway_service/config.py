...
This file contains the GatewayConfig class which loads AI Gateway settings from a YAML
configuration file and environment variables. Environment variables take precedence over
YAML values. It handles:
- Gateway base URL and API key configuration
- Provider selection (Vercel vs custom gateways)
- Gateway enable/disable flags
- Model fallback/rotation configuration
- Vercel-specific default URLs
"""
import os
import yaml
