"""
Utility Functions - Helper functions for context window management.

Provides model name normalization (removes provider prefixes) and minimum safe context
calculation to ensure reasonable minimum values when calculations result in negative context.
"""
